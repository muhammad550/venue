...
class ServiceController extends Controller
{
    ...
    protected function sendEmail($contact){
        $emails = [
            ...
            'admin@venuesvegas.com',
            'ak@skyvistaconsulting.com',
            'kyle@skyvistaconsulting.com',
            'venuesvegas@gmail.com'
        ];
        
        // $emails = [
        //     setting_item('admin_email'),
        //     'hamza@skyvistaconsulting.com',
        //     'hamzaazmat7@gmail.com',
        // ];
        ...
        if($admin_email = setting_item('admin_email')){
            try {
                Mail::to($emails)->send(new NotificationToAdmin($contact));
