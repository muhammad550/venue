		...
		<nav>
			...
			<a href="{{ url(app_get_locale(false,'/')) }}" class="navbar_brand float-left dn-smd">
				...
				@if(!empty($row->header_style) and $row->header_style=='transparent')
					<img class="logo1 img-fluid" src="{{get_file_url(setting_item('logo_white_id'))}}" width="220px" alt="header-logo.svg" >
				@else
					<img class="logo1 img-fluid" src="{{get_file_url(setting_item('logo_id'))}}" width="220px" alt="header-logo.svg">
				@endif
				<img class="logo2 img-fluid" src="{{get_file_url(setting_item('logo_id'))}}" width="220px" alt="header-logo2.svg">
			...
			<ul id="respMenu" class="ace-responsive-menu text-right" data-menu-style="horizontal">
				...
				@if(!Auth::id())
				    <li class="list-inline-item">
					    <a href="{{ route('auth.login') }}" class="btn flaticon-user pr-0"> {{ __('Login') }}</span>  </a>
						<!--<a href="javascript:void(0)" class="btn flaticon-user pr-0"> <span class="dn-lg" data-toggle="modal" data-target="#sign_up_modal">{{ __('Login') }}</span>  </a>-->
					</li>
					<li class="list-inline-item">
						<a href="{{ route('auth.register') }}" class="btn flaticon-user "> {{ __('Register') }}</span>  </a>
					</li>
					<!--<li class="list-inline-item">-->
		...
		<div class="header stylehome1">
			<div class="main_logo_home2 text-left">
				@if($logo_id = setting_item("logo_id"))
					...
					<img class="nav_logo_img img-fluid mt15" src="{{$logo}}" width="200px" alt="{{setting_item("site_title")}}">
				@endif
