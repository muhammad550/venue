...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Guido'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('VenueVegas')}} <a href="{{__('https://skyvistaconsulting.com/')}}" target="_blank">{{__('SkyVista 360')}}</a>
                    </div>
                    <div class="col-md-6">
